...
import cv2 as cv
import numpy as np
from model.mainModel_valid import MainModel as SHmodel
from util.config import CONFIG
from util.manage_model import load
...
output_name = file_name.split('.')[0] + '_output.mp4'
...
loaded_model, _, _, _ = load(SHmodel, CONFIG.device, CONFIG.parameter_dir)
loaded_model.eval()
